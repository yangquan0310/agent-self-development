...
| 里程碑 | 时间 | 交付物 | 状态 |
|--------|------|--------|------|
| M1 | 2026-05-20 | 目录清理 + utils 提取 + objects 精简 | 🚧 待启动 |
| M2 | 2026-05-22 | tools 重写 + schemas 精简 + 插件入口适配 | 🚧 待启动 |
| M3 | 2026-05-25 | 测试套件重写 + README/SKILL.md 更新 | 🚧 待启动 |
| M4 | 2026-05-28 | 验收 + 发布 v4.3.0 | 🚧 待启动 |
